...
namespace Printer.StoreServiceReference {
    ...
    public partial class Order : object, System.Runtime.Serialization.IExtensibleDataObject, System.ComponentModel.INotifyPropertyChanged {
        ...
        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private Printer.StoreServiceReference.Book bookField;
        
        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private Printer.StoreServiceReference.Client clientField;
        ...
        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private Printer.StoreServiceReference.Order.State stateField;
        ...
        [System.Runtime.Serialization.DataMemberAttribute()]
        public Printer.StoreServiceReference.Book book {
            get {
        ...
        [System.Runtime.Serialization.DataMemberAttribute()]
        public Printer.StoreServiceReference.Client client {
            get {
        ...
        [System.Runtime.Serialization.DataMemberAttribute()]
        public Printer.StoreServiceReference.Order.State state {
            get {
        ...
        public partial class State : object, System.Runtime.Serialization.IExtensibleDataObject, System.ComponentModel.INotifyPropertyChanged {
            ...
            [System.Runtime.Serialization.OptionalFieldAttribute()]
            private Printer.StoreServiceReference.Order.State.Type typeField;
            ...
            [System.Runtime.Serialization.DataMemberAttribute()]
            public Printer.StoreServiceReference.Order.State.Type type {
                get {
    ...
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName="StoreServiceReference.IStoreDualService", CallbackContract=typeof(Printer.StoreServiceReference.IStoreDualServiceCallback))]
    public interface IStoreDualService {
        ...
        Printer.StoreServiceReference.Book[] GetBooks();
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IStoreDualService/GetBooks", ReplyAction="http://tempuri.org/IStoreDualService/GetBooksResponse")]
        System.Threading.Tasks.Task<Printer.StoreServiceReference.Book[]> GetBooksAsync();
        ...
        Printer.StoreServiceReference.Client[] GetClients();
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IStoreDualService/GetClients", ReplyAction="http://tempuri.org/IStoreDualService/GetClientsResponse")]
        System.Threading.Tasks.Task<Printer.StoreServiceReference.Client[]> GetClientsAsync();
        ...
        Printer.StoreServiceReference.Order[] GetClientOrders(string clientId);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IStoreDualService/GetClientOrders", ReplyAction="http://tempuri.org/IStoreDualService/GetClientOrdersResponse")]
        System.Threading.Tasks.Task<Printer.StoreServiceReference.Order[]> GetClientOrdersAsync(string clientId);
        ...
        Printer.StoreServiceReference.Book GetBook(string id);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IStoreDualService/GetBook", ReplyAction="http://tempuri.org/IStoreDualService/GetBookResponse")]
        System.Threading.Tasks.Task<Printer.StoreServiceReference.Book> GetBookAsync(string id);
        ...
        Printer.StoreServiceReference.Order[] GetOrders();
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IStoreDualService/GetOrders", ReplyAction="http://tempuri.org/IStoreDualService/GetOrdersResponse")]
        System.Threading.Tasks.Task<Printer.StoreServiceReference.Order[]> GetOrdersAsync();
        ...
        Printer.StoreServiceReference.Order CreateOrder(int clientId, int bookId, int quantity);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IStoreDualService/CreateOrder", ReplyAction="http://tempuri.org/IStoreDualService/CreateOrderResponse")]
        System.Threading.Tasks.Task<Printer.StoreServiceReference.Order> CreateOrderAsync(int clientId, int bookId, int quantity);
        ...
        Printer.StoreServiceReference.Client CreateClient(string name, string address, string email);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IStoreDualService/CreateClient", ReplyAction="http://tempuri.org/IStoreDualService/CreateClientResponse")]
        System.Threading.Tasks.Task<Printer.StoreServiceReference.Client> CreateClientAsync(string name, string address, string email);
        ...
        Printer.StoreServiceReference.Order NotifyFutureArrival(string bookTitle, int quantity, System.Guid orderGuid);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IStoreDualService/NotifyFutureArrival", ReplyAction="http://tempuri.org/IStoreDualService/NotifyFutureArrivalResponse")]
        System.Threading.Tasks.Task<Printer.StoreServiceReference.Order> NotifyFutureArrivalAsync(string bookTitle, int quantity, System.Guid orderGuid);
    ...
    public interface IStoreDualServiceCallback {
        ...
        void OrderCreated(Printer.StoreServiceReference.Order order);
        
        [System.ServiceModel.OperationContractAttribute(IsOneWay=true, Action="http://tempuri.org/IStoreDualService/OrderStateUpdated")]
        void OrderStateUpdated(Printer.StoreServiceReference.Order order);
        ...
        void ClientAdded(Printer.StoreServiceReference.Client client);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IStoreDualServiceChannel : Printer.StoreServiceReference.IStoreDualService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class StoreDualServiceClient : System.ServiceModel.DuplexClientBase<Printer.StoreServiceReference.IStoreDualService>, Printer.StoreServiceReference.IStoreDualService {
        ...
        public Printer.StoreServiceReference.Book[] GetBooks() {
            return base.Channel.GetBooks();
        }
        
        public System.Threading.Tasks.Task<Printer.StoreServiceReference.Book[]> GetBooksAsync() {
            return base.Channel.GetBooksAsync();
        }
        
        public Printer.StoreServiceReference.Client[] GetClients() {
            return base.Channel.GetClients();
        }
        
        public System.Threading.Tasks.Task<Printer.StoreServiceReference.Client[]> GetClientsAsync() {
            return base.Channel.GetClientsAsync();
        }
        
        public Printer.StoreServiceReference.Order[] GetClientOrders(string clientId) {
            return base.Channel.GetClientOrders(clientId);
        }
        
        public System.Threading.Tasks.Task<Printer.StoreServiceReference.Order[]> GetClientOrdersAsync(string clientId) {
            return base.Channel.GetClientOrdersAsync(clientId);
        }
        
        public Printer.StoreServiceReference.Book GetBook(string id) {
            return base.Channel.GetBook(id);
        }
        
        public System.Threading.Tasks.Task<Printer.StoreServiceReference.Book> GetBookAsync(string id) {
            return base.Channel.GetBookAsync(id);
        }
        
        public Printer.StoreServiceReference.Order[] GetOrders() {
            return base.Channel.GetOrders();
        }
        
        public System.Threading.Tasks.Task<Printer.StoreServiceReference.Order[]> GetOrdersAsync() {
            return base.Channel.GetOrdersAsync();
        }
        
        public Printer.StoreServiceReference.Order CreateOrder(int clientId, int bookId, int quantity) {
            return base.Channel.CreateOrder(clientId, bookId, quantity);
        }
        
        public System.Threading.Tasks.Task<Printer.StoreServiceReference.Order> CreateOrderAsync(int clientId, int bookId, int quantity) {
            return base.Channel.CreateOrderAsync(clientId, bookId, quantity);
        }
        
        public Printer.StoreServiceReference.Client CreateClient(string name, string address, string email) {
            return base.Channel.CreateClient(name, address, email);
        }
        
        public System.Threading.Tasks.Task<Printer.StoreServiceReference.Client> CreateClientAsync(string name, string address, string email) {
            return base.Channel.CreateClientAsync(name, address, email);
        }
        
        public Printer.StoreServiceReference.Order NotifyFutureArrival(string bookTitle, int quantity, System.Guid orderGuid) {
            return base.Channel.NotifyFutureArrival(bookTitle, quantity, orderGuid);
        }
        
        public System.Threading.Tasks.Task<Printer.StoreServiceReference.Order> NotifyFutureArrivalAsync(string bookTitle, int quantity, System.Guid orderGuid) {
